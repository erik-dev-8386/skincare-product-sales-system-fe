...
export default function Products() {
  ...
  const [compareProducts, setCompareProducts] = useState([]);
  const [isCompareModalVisible, setIsCompareModalVisible] = useState(false);
  const [visibleProducts, setVisibleProducts] = useState(12); // State để lưu số lượng sản phẩm hiển thị
  ...
  const handleLoadMore = () => {
    setVisibleProducts((prevVisibleProducts) => prevVisibleProducts + 12); // Tăng số lượng sản phẩm hiển thị thêm 12
  };
  ...
  const filterProducts = (
    ...
    setFilteredProducts(filtered);
    setVisibleProducts(12); // Reset số lượng sản phẩm hiển thị khi filter
  };
