      ...
      <>
        ...
        <div className="container">
          <div className="row">
            <h5 className="trang">
              {" "}
              Trang chủ {">"} Lộ trình chăm sóc da {">"} Da khô
            </h5>
          </div>
          <div className="row">
          ...
          <div className="row">
            <div className="col-6 list-container">
              <h5 className="skin">
                {" "}
                Các bước chăm sóc da khô dành cho ban ngày
              </h5>
              <br />
            ...
            <div className="col-6 list-container">
              <h5 className="skin">
                Các bước chăm sóc da khô dành cho ban đêm
              </h5>
              <br />
              <ul className="buoctaytrang">
                <li className="buoc">Bước 1: Tẩy trang</li>
          ...
          <div className="row">
            <div className="col-12">
              <h3 className="san">Một số sản phẩm dành cho da khô</h3> <br />
              <br />
            </div>
          </div>
          <div className="row">
