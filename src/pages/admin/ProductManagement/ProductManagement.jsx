...
const ProductManagement = () => {
    ...
    const handleSubmitForm = async (values) => {
        ...
        // Append product data as JSON
        formData.append("products", new Blob([JSON.stringify(values)], { type: "application/json" }));
                    ...
                    <Row gutter={16}>
                        ...
                        <Col span={12}>
                            ...
                            <Form.Item
                                label="Loại da"
                                name="skinTypeId"
                                rules={[{ required: true, message: "Loại da không được để trống!" }]}
                            >
                                <Select>
                            ...
                            <Form.Item
                                label="Giảm giá"
                                name="discountId"
                                rules={[{ required: true, message: "Giảm giá không được để trống!" }]}
                            >
                                <Select>
                    ...
                    <Form.Item label="Tải hình ảnh lên">
                        <Upload
                            ...
                            beforeUpload={(file) => {
                                ...
                                setImagePreviews(prev => [...prev, URL.createObjectURL(file)]); // Create temporary URL for preview
                        ...
                        {imagePreviews.map((preview, index) => (
                            <img key={index} src={preview} alt="Preview" style={{ width: 100, marginTop: 8, marginRight: 8 }} />
                        ))}
                    </Form.Item>
                </Form>
            </Modal>
