...
const SkinTypeManagement = () => {
    ...
    const handleDeleteSkinType = async (skinTypeId) => {
        try {
            ...
            console.error("Error deleting skin type:", error.response?.data?.message || error.message);
                            ...
                            <Form.Item label="Tải hình ảnh lên">
                                <Upload
                                    ...
                                    beforeUpload={(file) => {
                                        ...
                                        setImagePreviews(prev => [...prev, URL.createObjectURL(file)]); // Tạo URL tạm thời để hiển thị ảnh
